...
namespace KJFramework.Platform.Deploy.SMC.Test
{
    ...
    /// <summary>
    ///This is a test class for DSUpdateProcessingMessageProcessorTest and is intended
    ///to contain all DSUpdateProcessingMessageProcessorTest Unit Tests
    ///</summary>
    [TestClass()]
    public class DSUpdateProcessingMessageProcessorTest
    {
        #region Members
        ...
        {
            Regist();
            DSUpdateProcessingMessageProcessor target = new DSUpdateProcessingMessageProcessor(); // TODO: Initialize to an appropriate value
            Guid id = new Guid(); // TODO: Initialize to an appropriate value
            DynamicServiceUpdateProcessingMessage message =new DynamicServiceUpdateProcessingMessage();
            message.ServiceName = "ServiceName";
            message.Content = "Updating now~";
            message.Bind();
