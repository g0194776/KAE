...
namespace KJFramework.UI.Imaging
{
    ...
    class GifAnimation : Viewbox
    {
        ...
        private int ParseBlock(byte[] gifData, int offset)
        {
            switch (gifData[offset])
            {
                ...
                case 0x3B:
                    return -1;
                default:
                    throw new System.Exception("GIF format incorrect: missing graphic block or special-purpose block. ");
            }
        }
        ...
        private int ParseHeader(byte[] gifData, int offset)
        {
            ...
            if (str != "GIF")
            {
                throw new System.Exception("Not a proper GIF file: missing GIF header");
            }
            return 6;
        }
        ...
        public void NextFrame(object sender, System.EventArgs e)
        {
            frameTimer.Stop();
