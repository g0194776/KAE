...
namespace KJFramework.UI.Imaging
{
    ...
    public class GifImage : System.Windows.Controls.UserControl
    {
        ...
        void RaiseImageFailedEvent(System.Exception exp)
        {
        ...
        private delegate void WebRequestErrorDelegate(System.Exception exp);

        private void WebRequestError(System.Exception exp)
        {
            RaiseImageFailedEvent(exp);
        }
