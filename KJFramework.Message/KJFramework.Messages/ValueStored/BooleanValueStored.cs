...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     Boolean类型的存储
    /// </summary>
    public class BooleanValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     Boolean类型存储的初始化构造器
        /// </summary>
        public BooleanValueStored()
        {
            _typeId = (byte)PropertyTypes.Boolean;
        }

        /// <summary>
        ///     Boolean类型存储的初始化构造器
        /// </summary>
        public BooleanValueStored(bool value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.Boolean;
        }
        ...
        ///     Boolean类型存储的静态构造器
        /// </summary>
        static BooleanValueStored()
        {
            _instance = ValueStoredHelper.BuildMethod<bool>();
            _toBytesDelegate = ProcessorDictionary.ValueActions[(byte)PropertyTypes.Boolean];
            _toDataDelegate = ProcessorDictionary.DataActions[(byte)PropertyTypes.Boolean];
        }
