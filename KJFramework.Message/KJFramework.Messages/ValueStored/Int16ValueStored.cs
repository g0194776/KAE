...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     Int16类型的存储
    /// </summary>
    public class Int16ValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     Int16类型存储的初始化构造器
        /// </summary>
        public Int16ValueStored()
        {
            _typeId = (byte)PropertyTypes.Int16;
        }

        /// <summary>
        ///     Int16类型存储的初始化构造器
        /// </summary>
        public Int16ValueStored(short value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.Int16;
        }
