...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     Boolean数组类型的存储
    /// </summary>
    public class BooleanArrayValueStored : BaseValueStored
    {
        #region Members

        private readonly bool[] _value;
        private static readonly PropertyValueStored<bool[]> _instance;
        ...
        /// </summary>
        public BooleanArrayValueStored()
        {
            _typeId = (byte)PropertyTypes.BooleanArray;
        }

        /// <summary>
        ///     Boolean数组类型存储的初始化构造器
        /// </summary>
        public BooleanArrayValueStored(bool[] value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.BooleanArray;
        ...
        ///     Boolean数组类型存储的静态构造器
        /// </summary>
        static BooleanArrayValueStored()
        {
            _instance = ValueStoredHelper.BuildMethod<bool[]>();
            _toBytesDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.BooleanArray)).ValueProcessor;
            _toDataDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.BooleanArray)).DataProcessor;
        }
        ...
        {
            return new BooleanArrayValueStored();
        }
