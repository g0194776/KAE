...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     Char类型的存储
    /// </summary>
    public class CharValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     Char类型存储的初始化构造器
        /// </summary>
        public CharValueStored()
        {
            _typeId = (byte)PropertyTypes.Char;
        }

        /// <summary>
        ///     Char类型存储的初始化构造器
        /// </summary>
        public CharValueStored(char value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.Char;
        }
