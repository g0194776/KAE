...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     String类型的存储
    /// </summary>
    public class StringValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     String类型存储的初始化构造器
        /// </summary>
        public StringValueStored()
        {
            _typeId = (byte)PropertyTypes.String;
        }

        /// <summary>
        ///     String类型存储的初始化构造器
        /// </summary>
        public StringValueStored(string value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.String;
