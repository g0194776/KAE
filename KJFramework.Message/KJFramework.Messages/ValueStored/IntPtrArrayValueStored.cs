...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     IntPtr数组类型的存储
    /// </summary>
    public class IntPtrArrayValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     IntPtr数组类型存储的初始化构造器
        /// </summary>
        public IntPtrArrayValueStored()
        {
            _typeId = (byte)PropertyTypes.IntPtrArray;
        }

        /// <summary>
        ///     IntPtr数组类型存储的初始化构造器
        /// </summary>
        public IntPtrArrayValueStored(IntPtr[] value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.IntPtrArray;
        ...
        {
            return new IntPtrArrayValueStored();
        }
