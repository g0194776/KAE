...
namespace KJFramework.Messages.TypeProcessors
{
    ...
    /// </summary>
    public class Int32IntellectTypeProcessor : IntellectTypeProcessor
    {
        #region 构造函数
        ...
        ///     Int32类型智能处理器，提供了相关的基本操作。
        /// </summary>
        public Int32IntellectTypeProcessor()
        {
        ...
        {
            BitConvertHelper.GetBytes((int)value, memory, offset);
        }
        ...
        public override void Process(IMemorySegmentProxy proxy, IntellectPropertyAttribute attribute, ToBytesAnalyseResult analyseResult, object target, bool isArrayElement = false, bool isNullable = false)
        {
            ...
            if (attribute.AllowDefaultNull && value.Equals(DefaultValue.Int32) && !isArrayElement) return;
            proxy.WriteByte((byte)attribute.Id);
            proxy.WriteInt32(value);
        }
        ...
        {
            if (result.Nullable) result.SetValue<int?>(instance, BitConverter.ToInt32(data, offset));
            else result.SetValue(instance, BitConverter.ToInt32(data, offset));
        }
