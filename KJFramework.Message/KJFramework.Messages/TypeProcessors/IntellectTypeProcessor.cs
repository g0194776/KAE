...
namespace KJFramework.Messages.TypeProcessors
{
    ...
    public abstract class IntellectTypeProcessor : IIntellectTypeProcessor
    {
        ...
        public abstract void Process(byte[] memory, int offset, IntellectPropertyAttribute attribute, object value);
        /// <summary>
        ///     从第三方客户数据转换为元数据
        /// </summary>
        ...
        public abstract byte[] Process(IntellectPropertyAttribute attribute, object value);
        /// <summary>
        ///     从元数据转换为第三方客户数据
        /// </summary>
        /// <param name="attribute">当前字段标注的属性</param>
        ...
        /// <returns>返回转换后的第三方客户数据</returns>
        /// <exception cref="Exception">转换失败</exception>
        public abstract object Process(IntellectPropertyAttribute attribute, byte[] data, int offset, int length = 0);
