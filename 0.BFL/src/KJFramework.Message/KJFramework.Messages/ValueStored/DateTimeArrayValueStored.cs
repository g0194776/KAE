...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     DateTime数组类型的存储
    /// </summary>
    public class DateTimeArrayValueStored : BaseValueStored
    {
        #region Members
        ...
        /// </summary>
        public DateTimeArrayValueStored()
        {
            _typeId = (byte)PropertyTypes.DateTimeArray;
        }

        /// <summary>
        ///     DateTime数组类型存储的初始化构造器
        /// </summary>
        public DateTimeArrayValueStored(DateTime[] value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.DateTimeArray;
        ...
        /// </summary>
        static DateTimeArrayValueStored()
        {
            _instance = ValueStoredHelper.BuildMethod<DateTime[]>();
            _toBytesDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.DateTimeArray)).ValueProcessor;
            _toDataDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.DateTimeArray)).DataProcessor;
        }
        ...
        {
            return new DateTimeArrayValueStored();
        }
