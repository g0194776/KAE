...
namespace KJFramework.Messages.ValueStored
{
    ...
    ///     Int64数组对象类型的存储
    /// </summary>
    public class Int64ArrayValueStored : BaseValueStored
    {
        #region Members
        ...
        ///     Int64数组类型存储的初始化构造器
        /// </summary>
        public Int64ArrayValueStored()
        {
            _typeId = (byte)PropertyTypes.Int64Array;
        }

        /// <summary>
        ///     Int64数组类型存储的初始化构造器
        /// </summary>
        public Int64ArrayValueStored(long[] value)
        {
            _value = value;
            _typeId = (byte) PropertyTypes.Int64Array;
        ...
        ///     Int64数组类型存储的静态构造器
        /// </summary>
        static Int64ArrayValueStored()
        {
            _instance = ValueStoredHelper.BuildMethod<long[]>();
            _toBytesDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.Int64Array)).ValueProcessor;
            _toDataDelegate = (DataProcessorMapping.Instance.GetProcessor(PropertyTypes.Int64Array)).DataProcessor;
        }
        ...
        {
            return new Int64ArrayValueStored();
        }
