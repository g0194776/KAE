...
namespace KJFramework.Net.Transaction.Pools
{
    ...
    public class MetadataSystemConnectionPool : ConnectionPool<MetadataContainer>
    {
        ...
        protected override IServerConnectionAgent<MetadataContainer> CreateAgent(IPEndPoint iep, IProtocolStack<MetadataContainer> protocolStack, object transactionManager)
        {
