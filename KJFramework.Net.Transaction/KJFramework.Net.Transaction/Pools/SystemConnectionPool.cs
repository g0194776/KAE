...
//        private static readonly ITracing _tracing = TracingManager.GetTracing(typeof (SystemConnectionPool));
...
//        public IServerConnectionAgent GetChannel(string key, ServiceRoles role, IProtocolStack<BaseMessage> protocolStack, MessageTransactionManager transactionManager)
//        {
//            try
//            {
//                string fullKey = string.Format("{0}#{1}", role, key);
