...
namespace KJFramework.Net.Transaction.Agent
{
    ...
    ///     连接代理器，提供了相关的基本操作
    /// </summary>
    public class ConnectionAgent : IServerConnectionAgent
    {
        #region Constructor
        ...
        public ConnectionAgent(IMessageTransportChannel<BaseMessage> channel, MessageTransactionManager transactionManager)
        {
        ...
        protected static readonly ITracing _tracing = TracingManager.GetTracing(typeof (ConnectionAgent));
        ...
        public static IServerConnectionAgent Create(IPEndPoint iep, IProtocolStack<BaseMessage> protocolStack, MessageTransactionManager transactionManager)
        {
            ...
            return new ConnectionAgent(msgChannel, transactionManager);
        }
