...
namespace KJFramework.Net.Transaction.Clusters
{
    ...
    ///     按照普通HASH方式的网络群集负载器
    /// </summary>
    public class MetadataContainerHashNetworkCluster : INetworkCluster<MetadataContainer>
    {
        #region Constructor
        ...
        ///     按照普通HASH方式的网络群集负载器
        /// </summary>
        private MetadataContainerHashNetworkCluster(MetadataTransactionManager transactionManager, MetadataSystemConnectionPool connectionPool, Dictionary<string, ServiceCoreConfig[]> addresses, Dictionary<string, int> maxRanges)
        {
        ...
        private readonly MetadataSystemConnectionPool _connectionPool;
        private readonly MetadataTransactionManager _transactionManager;
        ...
        private static readonly ITracing _tracing = TracingManager.GetTracing(typeof(MetadataContainerHashNetworkCluster));
        ...
        public IServerConnectionAgent<MetadataContainer> GetChannel(string roleId, IProtocolStack<MetadataContainer> protocolStack, out string errMsg)
        {
        ...
        /// <returns>如果指定条件的通信信道不存在，则会创建它并返回</returns>
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        public IServerConnectionAgent<MetadataContainer> GetChannelBySpecificCondition(string roleId, IProtocolStack<MetadataContainer> protocolStack, int balanceFlag, out string errMsg)
        {
            ServiceCoreConfig[] configs;
            if (protocolStack == null) throw new ArgumentNullException("protocolStack");
            if (!_addresses.TryGetValue(roleId, out configs))
        ...
        /// <returns>如果指定条件的通信信道不存在，则会创建它并返回</returns>
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        public IServerConnectionAgent<MetadataContainer> GetChannelBySpecificCondition(string roleId, IProtocolStack<MetadataContainer> protocolStack, long balanceFlag, out string errMsg)
        {
            ServiceCoreConfig[] configs;
            if (protocolStack == null) throw new ArgumentNullException("protocolStack");
            if (!_addresses.TryGetValue(roleId, out configs))
        ...
        /// <returns>如果指定条件的通信信道不存在，则会创建它并返回</returns>
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        public IServerConnectionAgent<MetadataContainer> GetChannelBySpecificCondition(string roleId, IProtocolStack<MetadataContainer> protocolStack, string balanceFlag, out string errMsg)
        {
            ServiceCoreConfig[] configs;
            if (protocolStack == null) throw new ArgumentNullException("protocolStack");
        ...
        /// <returns>如果指定条件的通信信道不存在，则会创建它并返回</returns>
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        public IServerConnectionAgent<MetadataContainer> GetChannelBySpecificCondition(string roleId, IProtocolStack<MetadataContainer> protocolStack, Guid balanceFlag, out string errMsg)
        {
            ServiceCoreConfig[] configs;
            if (protocolStack == null) throw new ArgumentNullException("protocolStack");
            if (!_addresses.TryGetValue(roleId, out configs))
        ...
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        public static MetadataContainerHashNetworkCluster Create(MetadataTransactionManager transactionManager, MetadataSystemConnectionPool connectionPool, Dictionary<string, ServiceCoreConfig[]> addresses, Dictionary<string, int> maxRanges)
        {
            ...
            return new MetadataContainerHashNetworkCluster(transactionManager, connectionPool, addresses, maxRanges);
        }
