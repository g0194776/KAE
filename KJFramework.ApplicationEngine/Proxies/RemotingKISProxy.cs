...
namespace KJFramework.ApplicationEngine.Proxies
{
    ...
    /// </summary>
    internal static class RemotingKISProxy
    {
        #region Members.
        ...
        public static void Initialize(string kisAddress)
        {
        ...
        /// <returns></returns>
        public static PackageInfo GetReallyRemotingAddress(string kppName, string version)
        {
