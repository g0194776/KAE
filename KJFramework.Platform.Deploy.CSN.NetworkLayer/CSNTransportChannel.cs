...
namespace KJFramework.Platform.Deploy.CSN.NetworkLayer
{
    ...
    ///     传输通道抽象父类，提供了相关的基本操作。
    /// </summary>
    public abstract class CSNTransportChannel : ServiceChannel, ICSNRawTransportChannel
    {
        #region Constructor
        ...
        #region Implementation of ICSNRawTransportChannel
        ...
        ///     接收到数据片段事件
        /// </summary>
        public event EventHandler<CSNSegmentReceiveEventArgs> ReceivedDataSegment;
        protected void ReceivedDataSegmentHandler(CSNSegmentReceiveEventArgs e)
        {
            EventHandler<CSNSegmentReceiveEventArgs> handler = ReceivedDataSegment;
