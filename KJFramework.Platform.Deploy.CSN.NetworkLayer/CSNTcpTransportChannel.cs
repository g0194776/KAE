...
namespace KJFramework.Platform.Deploy.CSN.NetworkLayer
{
    ...
    /// </summary>
    public class CSNTcpTransportChannel : CSNTransportChannel, ITcpTransportChannel, IReconnectionTransportChannel
    {
        #region 成员

        protected Socket _socket;
        protected int _channelKey;
        protected CSNTcpAsynDataRecevier _receiver;
        private static readonly ITracing _tracing = TracingManager.GetTracing(typeof(CSNTcpTransportChannel));
        ...
        public CSNTcpTransportChannel(string ip, int port)
        ...
        /// <exception cref="ArgumentNullException">参数错误</exception>
        public CSNTcpTransportChannel(IPEndPoint iep)
        {
        ...
        /// <exception cref="ArgumentNullException">参数错误</exception>
        public CSNTcpTransportChannel(Socket socket)
        {
        ...
        protected void InitializeReceiver()
        {
            ...
            _receiver = new CSNTcpAsynDataRecevier(_socket);
        ...
        protected override int InnerSend(byte[] data)
        {
            ...
            try
            {
                ...
                if (data.Length > CSNChannelConst.MaxMessageDataLength)
                {
                    _tracing.Warn(string.Format("#Illegal data size: {0}, current allow size: {1}", data.Length, CSNChannelConst.MaxMessageDataLength));
                    return -1;
                }
                //get fixed cache.
                IFixedCacheStub<CSNNoBuffSocketStub> stub = CSNChannelConst.NoBuffAsyncStubPool.Rent();
                if (stub == null)
                {
        ...
        /// </summary>
        protected virtual void RecvData(object sender, CSNSegmentReceiveEventArgs e)
        {
